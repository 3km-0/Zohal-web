      ...
      return [
        ...
        },
        {
          ...
          popover: {
            ...
            description:
              'These tabs are the main workspace surfaces: Documents (your files), Notes (workspace notes), Reports (saved outputs like decision packs), and Packs (bundles + pinned reference context).',
            side: 'bottom',
            align: 'start',
          },
        },
