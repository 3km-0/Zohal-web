...
import { FileText, Layers, MessageSquare, Package, ScrollText, StickyNote, Users } from 'lucide-react';
import type { ComponentType } from 'react';

type WorkspaceTabKey = 'documents' | 'ask' | 'notes' | 'reports' | 'pipelines' | 'packs' | 'members';
