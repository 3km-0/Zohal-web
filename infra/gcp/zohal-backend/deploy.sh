...
ANALYSIS_WORKFLOW_FILE="${SERVICE_DIR}/workflows/document-analysis-v1.yaml"
...
ANALYSIS_WORKFLOW_NAME="${ANALYSIS_WORKFLOW_NAME:-document-analysis-v1}"
ANALYSIS_TASK_QUEUE_NAME="${ANALYSIS_TASK_QUEUE_NAME:-document-analysis-jobs}"
...
DEFAULT_ENV_VARS="GCP_PROJECT_ID=${PROJECT_ID},GCP_WORKFLOWS_LOCATION=${ORCHESTRATION_REGION},GCP_DOCUMENT_INGESTION_WORKFLOW=${INGESTION_WORKFLOW_NAME},GCP_TASKS_LOCATION=${ORCHESTRATION_REGION},GCP_DOCUMENT_INGESTION_TASK_QUEUE=${INGESTION_TASK_QUEUE_NAME},GCP_DOCUMENT_ANALYSIS_WORKFLOW=${ANALYSIS_WORKFLOW_NAME},GCP_DOCUMENT_ANALYSIS_TASK_QUEUE=${ANALYSIS_TASK_QUEUE_NAME},GCP_CONTRACT_ANALYSIS_WORKFLOW=${ANALYSIS_WORKFLOW_NAME},GCP_CONTRACT_ANALYSIS_TASK_QUEUE=${ANALYSIS_TASK_QUEUE_NAME}"
if [[ -n "${SUPABASE_URL:-}" ]]; then
  DEFAULT_ENV_VARS="${DEFAULT_ENV_VARS},SUPABASE_URL=${SUPABASE_URL}"
fi
